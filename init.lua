...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Add telescope-media-files.nvim
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          media_files = {
            filetypes = { 'png', 'jpg', 'jpeg', 'bmp', 'gif', 'tiff', 'mp4', 'webm', 'pdf' }, -- Allowed preview file types
      ...
      vim.keymap.set('n', '<leader>sa', builtin.git_status, { desc = '[S]earch Git [A]status' })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        ruff = {}, -- Ruff native LSP (lint, format, organize imports)
        -- rust_analyzer = {},
